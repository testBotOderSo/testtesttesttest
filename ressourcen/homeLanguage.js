document.addEventListener('DOMContentLoaded', () => {
    ...
    const switchToGerman = () => {
        ...
        p6.innerHTML = 'Mit dem Befehl <code>!prefix</code> lässt sich das Präfix je Kanal ändern.</br>';
    ...
    const switchToEnglish = () => {
        ...
        p6.innerHTML = 'The <code>!prefix</code> command can be used to change the prefix for each channel.<br/>';
