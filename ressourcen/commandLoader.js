document.addEventListener('DOMContentLoaded', () => {
    ...
    function getPermissionLabel(level) {
        const labels = {
            0: 'Everyone <img src="img/strichmannchen.png">',
            1: 'Vip <img src="img/vip.png"alt="Badge">',
            2: 'Moderator <img src="img/mod.png"alt="Badge">',
            3: 'Broadcaster <img src="img/broadcaster.png"alt="Badge">',
            4: 'Dev <img src="img/developerlookingadcode.png"alt="Badge">',
            5: 'Admin <img src="img/wydios.png"alt="Badge">'
        };
